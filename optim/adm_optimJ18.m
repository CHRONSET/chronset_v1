function adm_optimJ18(f,Nper,nworker,lf,m)
%%
if nargin == 0
    Nper = 350;% number of optim iterations
    f = 1;
    nworker = 128;
    lf = 1;
    m = 'new';
...
for jt = 1:length(ID)
    ...
    switch m
        ...
        case 'new'
            ...
            [id] = [raw{jt,3},'.',num2str(raw{jt,4}),'_',chck.date(1:11),'.mat'];            
    end;  
...
for jt = 1:length(sel_idx)
    ...
    switch m
        ...
        case 'new'
            ...
            id = chck.name;
            id2 = [ID2{jt},'.',num2str(trl_n(jt)),'_',chck.date(1:11),'.mat'];
    end;
...
if ( f == 1 )
    ...
    %%added June 13 2016
    itresh{7}  = .001;%syl length
    itresh{8}  = 3;%number of simult active features
...
%%
path2files = '/bcbl/home/home_a-f/froux/chronset/optim/adm_Jun18/';
